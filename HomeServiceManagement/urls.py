...
from django.urls import path
from home_service.views import payment_success
...
urlpatterns = [
    ...
    path('check_availability/<int:service_man_id>/', views.check_availability, name='check_availability'),
    ...
    path('submit-booking/', your_booking_submission_view, name='your_booking_submission_view'),
